...
public class StravaUpload {
    ...
    public void upload(String token, final String uploadType) {
        Toast.makeText(_context, R.string.alert_strava_uploading_please_wait, Toast.LENGTH_LONG).show();
                ...
                if (res.duplicate_activity_id > 0) {
                    ...
                    if (_sharedPreferences.getBoolean("STRAVA_DELETE_IF_EXISTS_DURING_UPLOAD", false)) {
                        ...
                        if (res2.serverResponseCode == 204) {
                            ...
                            message = _context.getString(R.string.alert_activity_updated);
                        } else {
                            message = _context.getString(R.string.alert_error_deleting_activity);
                        }
                    }
                }
    ...
    private ApiResult _upload(String strava_token, String gpx, final String uploadType) {
        ...
        String description = _context.getString(R.string.strava_upload_description);
        ...
        try {
            ...
            if (result.serverResponseCode == 201) {
                ...
                result.message = _context.getString(R.string.strava_upload_success);
                ...
                result.message = _context.getString(R.string.strava_upload_error);
                ...
                is = urlConnection.getErrorStream();
                result.message = _context.getString(R.string.strava_upload_unauthorized);
