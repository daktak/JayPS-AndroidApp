...
public class Constants {
    ...
    public static final int MSG_INDOOR = 0x2D;
    ...
    public static final String PREF_AUTOSTART_LIGHTS = "AUTOSTART_LIGHTS";
    public static final String PREF_AUTOSTART_GOPRO = "AUTOSTART_GOPRO";
